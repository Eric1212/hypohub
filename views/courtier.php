    ...
    <div class="section-inner wide">
        <div class="two-col">
            <div class="card">
                ...
                <ul class="accords">
                    <li>
                        <h4 class="toggle-title"><?php echo htmlspecialchars(t('bro.adv1.t'), ENT_QUOTES, 'UTF-8'); ?></h4>
                    ...
                    <li>
                        <h4 class="toggle-title"><?php echo htmlspecialchars(t('bro.adv2.t'), ENT_QUOTES, 'UTF-8'); ?></h4>
                        <div class="toggle-content" style="display: none;">
                            <div class="block">
                    ...
                    <li>
                        <h4 class="toggle-title"><?php echo htmlspecialchars(t('bro.adv3.t'), ENT_QUOTES, 'UTF-8'); ?></h4>
                        <div class="toggle-content" style="display: none;">
                            <div class="block">
...
<section class="section cta-big">
    <div class="section-inner">
        <div class="card contact cta-row">
            ...
            <?php if (auth_user()): ?>
                <a class="btn btn-alt btn-xl" href="index.php?page=espace"><?php echo htmlspecialchars(t('space.go'), ENT_QUOTES, 'UTF-8'); ?></a>
            <?php else: ?>
                <a class="btn btn-alt btn-xl" href="#" data-auth-open data-auth-acces="courtier"><?php echo htmlspecialchars(t('bro.cta.btn'), ENT_QUOTES, 'UTF-8'); ?></a>
            <?php endif; ?>
        </div>
    </div>
</section>
