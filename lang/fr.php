...
return array(
    ...
    // Zone compte (réglages + demandes)
    'nav.admin'               => 'Demandes',
    'space.account.title'     => 'Zone compte',
    'account.nom_complet'     => 'Nom complet',
    'account.username'        => 'Utilisateur',
    'account.courriel'        => 'Courriel',
    'account.save'            => 'Enregistrer',
    'account.save.saved'      => 'Enregistré',
    'account.save.error'      => 'Échec de l\'enregistrement',
    'account.error.vide'       => 'Aucune modification fournie.',
    'account.error.nom'        => 'Le nom complet est requis.',
    'account.error.username'   => 'Utilisateur invalide (3-80 caractères : lettres, chiffres, . _ -).',
    'account.error.username_prise' => 'Cet identifiant est déjà utilisé.',
    'account.error.courriel'   => 'Courriel invalide.',
    'account.error.courriel_prise' => 'Ce courriel est déjà utilisé.',
    'account.amf'             => 'N° de certificat AMF',
    'account.amf.non'         => 'Non vérifié',
    ...
    'account.cre.demander'    => 'Demander à être créancier',
    'account.cre.deja'        => 'Je suis déjà créancier',
    'account.error.deja_creancier' => 'Vous disposez déjà de l\'accès créancier.',
    'account.error.amf_vide'     => 'Entrez votre numéro de certificat avant de demander être courtier.',
    'account.error.deja_demande'   => 'Une demande est déjà en cours de traitement.',
    'account.error.justif_vide'    => 'Veuillez décrire votre besoin.',
    'account.error.justif_mots'    => 'La justification dépasse la limite de 2000 mots.',
    'account.cle.creancier.title'  => 'Demander à être créancier',
    'account.cle.creancier.intro'  => 'Décrivez pourquoi vous souhaitez devenir créancier. Un employé vous recontactera si une information manque.',
    'account.cle.creancier.justif' => 'Justification',
    'account.cle.creancier.limit'  => '2000 mots max.',
    'account.cle.creancier.submit' => 'Soumettre la demande',
    'account.cle.creancier.error'  => 'Une erreur est survenue.',
    ...
    'admin.creancier.title' => 'Accès créancier',
    'admin.creancier.list'  => 'Demandes d\'accès en attente',
    'admin.justif'        => 'Justification',
    'admin.email'         => 'Courriel',
    'admin.loading'       => 'Chargement…',
    'admin.empty'         => 'Aucune demande en attente.',
    'admin.ok_label'      => 'Approuver',
    ...
    'doc.select' => 'Choisir des fichiers (PDF, JPG, PNG, WebP)',
    ...
    'doc.error.mime'   => 'Format non supporté. PDF, JPG, PNG et WebP uniquement.',
    'doc.error.upload' => 'Échec de l\'envoi du fichier.',
    'doc.existing'       => 'Documents déjà joints :',
    'doc.view'           => 'Visualiser',
    'doc.download'       => 'Télécharger',
    'doc.rename'         => 'Renommer',
    'doc.change_type'    => 'Changer type',
    'doc.remove'         => 'Retirer',
    'doc.error.name'     => 'Nom de fichier invalide.',
